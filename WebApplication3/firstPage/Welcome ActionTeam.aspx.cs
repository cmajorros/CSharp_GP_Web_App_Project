...
{
    public partial class Welcome_ActionTeam : System.Web.UI.Page
    {
        ...
        {
            Session["CarACActivity_ID"] = e.Value.ToString();
            Response.Redirect("~/Training/CarActivityDetail.aspx");
        }
        ...
        {
            Session["CarACActivity_ID"] = GridView1.SelectedRow.Cells[1].Text.ToString();
            Response.Redirect("~/Training/CarActivityDetail.aspx");
        }
    }
}