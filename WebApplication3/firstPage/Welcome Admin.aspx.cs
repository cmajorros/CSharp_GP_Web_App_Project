...
namespace WebApplication3.firstPage
{
    public partial class Welcome_Admin : System.Web.UI.Page
    {
        ...
        {
            Session["CarAdminActivity_ID"] = GridView1.SelectedRow.Cells[1].Text.ToString();
            Response.Redirect("~/firstPage/GVAdminActivityDetail.aspx");
        }
        ...
        {
            Session["CarAdminActivity_ID"] = e.Value.ToString();
            Response.Redirect("~/firstPage/CarActivityDetailAdmin.aspx");
        }
    }
}