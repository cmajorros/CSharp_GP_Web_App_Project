...
{
    public partial class ActivityDetailGV : System.Web.UI.Page
    {
        clsDatabase dbconn = new clsDatabase();
        protected void Page_Load(object sender, EventArgs e)
        {
            string ID = Session["GVActivity_ID"].ToString();
        ...
        {
            string GA_ID = Session["GVActivity_ID"].ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string insertSB;
            insertSB = "insert into SubBudgets (Budget_ID, SB_Amount,Activity_ID) VALUES ('" + ddlBudget.SelectedValue + "','" + Amount + "','" + Session["GVActivity_ID"].ToString() + "');";
