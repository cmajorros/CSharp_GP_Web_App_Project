<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Training Search Result.aspx.cs" Inherits="WebApplication3.Training.WebForm3" %>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="txtSearch" runat="server" OnClick="this.value=''" 
                    Font-Italic="False" ForeColor="Gray" Width="238px" ></asp:TextBox>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="Activity_ID" 
                            DataNavigateUrlFormatString="~/Training/Edit Delete Training.aspx" 
