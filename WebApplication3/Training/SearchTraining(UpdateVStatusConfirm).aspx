<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SearchTraining(UpdateVStatusConfirm).aspx.cs" Inherits="WebApplication3.Training.SearchTraining_UpdateVStatus_" %>
...
WHERE [VJA_ID] = @VJA_ID ">
        ...
        <tr>
            <td class="style8">
                &nbsp;</td>
            <td class="style9">
                <asp:Panel ID="PanelNoV" runat="server" Visible="False">
                    <div class="style22">
                        <strong>
                        <br />
                        You have not selected any volunteers to join activity yet ! Please select 
                        volunteers to join first .
                        <br />
                        </strong>
                    </div>
                </asp:Panel>
