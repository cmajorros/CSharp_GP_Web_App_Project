<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UpdateComfirmV.aspx.cs" Inherits="WebApplication3.Campaign_MGT.UpdateComfirmV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" 
                        CssClass="style11" Width="598px" DataKeyNames="Activity_ID" 
...
WHERE Activity_ID = @Activity_ID " UpdateCommand="UPDATE [VolunteerJoinActivities] SET [VJA_Status] ='Confirmed'
WHERE [VJA_ID] = @VJA_ID " onselected="JV_Selected">
                            <SelectParameters>
                    ...
                    <asp:Panel ID="NoV" runat="server" Visible="False">
                        <div class="style12">
                            <strong>
                            <br />
